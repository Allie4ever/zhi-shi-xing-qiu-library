...
export default function Home() {
  ...
  return <main>
    ...
    <div className="workspace">
      ...
      <section className="hero"><div><p className="kicker">RESEARCH ARCHIVE / 研究档案</p><h1>把每一份材料，<em>变成可验证的判断。</em></h1></div><div className="hero-stats"><div><strong>{materials.length}</strong><span>材料总数</span></div><div><strong>{materials.filter((item) => item.sourceType === "local").length}</strong><span>本地导入</span></div></div></section>
